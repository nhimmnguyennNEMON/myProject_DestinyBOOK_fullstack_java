    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div>
                        <form action="StoreController" style="margin-right: 1rem;" class="right_alight" >
                    ...
                    <a href='StoreController?service=insertStore'><button class="submitkey" style="margin-left: 1rem;">Insert Store</button></a>&emsp;
