    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div>
                        <form action="TitleAuthorController" style="margin-right: 1rem;" class="right_alight" >
                    ...
                    <a href='TitleAuthorController?service=insertTitleAuthor'><button class="submitkey" style="margin-left: 1rem;">Insert TitleAuthor</button></a>&emsp;
                    <table class="table_style">
                        ...
                        <tbody>
                            ...
                            if (rs1.next()) {%>
                                ...
                                <td><a class='btn btn-outline-dark' style="color: green;" href='TitleAuthorController?service=updateTitleAuthor&authorID=<%=temp.getAu_id()%>&titleID=<%=temp.getTitle_id()%>'>Update</a></td>
                                <td><a class='btn btn-outline-dark' href='TitleAuthorController?service=deleteTitleAuthor&authorID=<%=temp.getAu_id()%>&titleID=<%=temp.getTitle_id()%>'>Delete</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
