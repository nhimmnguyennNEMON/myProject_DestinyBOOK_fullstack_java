    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div>
                        <form action="EmployeeController" style="margin-right: 1rem;" class="right_alight" >
                    ...
                    <a href='EmployeeController?service=insertEmployee'><button class="submitkey" style="margin-left: 1rem;">Insert Employee</button></a>&emsp;
                    <table class="table_style">
                        <h3><%= request.getAttribute("TABLE_TITLE")%></h3>
                        <h3>Amount Employee: <%=count%></h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class='btn btn-outline-dark' style="color: green;" href='EmployeeController?service=updateEmployee&employeeID=<%=temp.getEmp_id()%>'>Update</a></td>
                                <td><a class='btn btn-outline-dark' href='EmployeeController?service=deleteEmployee&employeeID=<%=temp.getEmp_id()%>'>Delete</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
