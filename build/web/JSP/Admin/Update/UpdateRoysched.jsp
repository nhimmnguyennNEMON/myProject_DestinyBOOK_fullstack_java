    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h1 class="col">Update Roysched</h1>
                <div class="col-md-9">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class='form-control bg-transparent' type='text' hidden id ='name' name='title_id' value='<%=rsRoysched.getString(1)%>'>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%=rsRoysched.getInt(4)%>
                                        <input class='form-control bg-transparent' type='number' hidden id ='royalty' name='royalty' value='<%=rsRoysched.getInt(4)%>'>
                                    </td>
                                </tr>
                            </tbody>
                            <%}%>
