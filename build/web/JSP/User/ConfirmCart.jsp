        ...
        <div class="container">
            <div class="row">
                <div class="col text-end">
                    ...
                    <h2 class="col">Confirm Buy Cart</h2>
                    <%}%>
                </div>
            </div>
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <form action="CartController" method="POST">
                                ...
                                <input hidden="" name="service" value="updateQty1">
                            </form>
                        </td>
...
<!--                <tfoot class="text-center">
            ...
            <div class=" text-end">
                ...
                <a style=" margin:  1rem;" name="link" class="btn btn-outline-secondary" href="CartController?service=showCart&username=<%=username%>"">Show Cart</a>
                <form action="CartController" method="POST">
                    <input hidden="" name="username" class="border-0 bg-transparent" value="<%=username%>">
                    <button type="submit" name="service" value="Checkout"style=" margin-right: 200px;" name="link" class="btn btn-outline-primary" >Checkout</button>
                    <select class="right_alight" name="payment">
                        <option name="payment" value="ON invoice">ON invoice</option>
                        <option name="payment" value="Net 60">Net 60</option>
                        <option name="payment" value="Net 30">Net 30</option>
                        <option name="payment" value="Payterms">Payterms</option>
                    </select>
                </form>
            </div>
            <%
